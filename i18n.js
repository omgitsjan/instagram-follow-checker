...
const I18N = {
  en: {
    ...
    impersonatorOn: "Impersonator on — enter a username and start analysis.",
    impersonatorOff: "Impersonator off — analyzing your own account again.",
  ...
  de: {
    ...
    impersonatorOn: "Impersonator an — Username eingeben und Analyse starten.",
    impersonatorOff: "Impersonator aus — wieder dein eigener Account.",
