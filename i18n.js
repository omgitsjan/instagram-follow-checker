...
const I18N = {
  en: {
    ...
    impersonatorHelp:
      "Type a public @username and press Load account. Stats are read-only. Disable to reset to your account.",
    impersonatorPlaceholder: "@username",
    impersonatorBannerTitle: "Impersonator · read-only",
    impersonatorBannerUser: "Viewing @{user}",
    impersonatorNeedUser: "Enter a username.",
    impersonatorReadOnly: "Read-only: follow / unfollow / remove are disabled.",
    impersonatorSubmit: "Load account",
    impersonatorDisable: "Disable Impersonator",
    ...
    impersonatorNotFound: "Could not load @{user}. Public account? Stay on instagram.com logged in.",
    impersonatorUseSubmit: "Use Settings → Load account for Impersonator.",
    impersonatorChip: "@{user} · Impersonator",
    impersonatorYou: "You",
    impersonatorReset: "Impersonator disabled. Fresh session — run Start analysis for your account.",
  ...
  de: {
    ...
    impersonator: "Impersonator",
    impersonatorHelp:
      "Öffentlichen @username eingeben und Account laden. Nur Lesen. Disable setzt alles zurück auf deinen Account.",
    impersonatorPlaceholder: "@username",
    impersonatorBannerTitle: "Impersonator · nur Lesen",
    impersonatorBannerUser: "Ansicht: @{user}",
    impersonatorNeedUser: "Username eingeben.",
    impersonatorReadOnly:
      "Nur Lesen: Folgen / Entfolgen / Entfernen deaktiviert.",
    impersonatorSubmit: "Account laden",
    impersonatorDisable: "Impersonator beenden",
    ...
    impersonatorNotFound:
      "@{user} nicht ladbar. Öffentlich? Auf instagram.com eingeloggt bleiben.",
    impersonatorUseSubmit: "Settings → Account laden für Impersonator.",
    impersonatorChip: "@{user} · Impersonator",
    impersonatorYou: "Du",
    impersonatorReset:
      "Impersonator beendet. Frischer Stand — „Analyse starten“ für deinen Account.",
