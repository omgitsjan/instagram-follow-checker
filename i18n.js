...
const I18N = {
  en: {
    ...
    chartAudienceTitle: "Audience balance",
    chartAudienceCenter: "lists",
    chartPrivacyTitle: "Followers · private",
    chartVerifiedTitle: "Following · verified",
    chartBotRiskTitle: "Followers · bot risk",
    chartMutual: "Mutual",
    chartNotBack: "Not following back",
    chartNotMe: "You don’t follow",
    chartPublic: "Public",
    chartPrivate: "Private",
    chartVerified: "Verified",
    chartNotVerified: "Not verified",
    chartRiskHigh: "High (≥55)",
    chartRiskMid: "Elevated (30–54)",
    chartRiskFlagged: "Flagged (25–29)",
    chartRiskClean: "Low (<25)",
    botsHint:
      "<strong>Heuristic only</strong> — not proof of bots. Only score ≥ 25. Sorted by risk among your followers.",
    needAnalysisFirst: "Run a full analysis first to unlock charts and bot scores.",
    metricMutualRate: "Mutual rate",
    metricNotBackRate: "Not-back rate",
    metricOneWayFollowers: "One-way followers",
    metricBotFlagged: "Bot-flagged",
  ...
  de: {
    ...
    chartAudienceTitle: "Audience-Balance",
    chartAudienceCenter: "Listen",
    chartPrivacyTitle: "Follower · privat",
    chartVerifiedTitle: "Following · verifiziert",
    chartBotRiskTitle: "Follower · Bot-Risiko",
    chartMutual: "Gegenseitig",
    chartNotBack: "Folgt nicht zurück",
    chartNotMe: "Du folgst nicht",
    chartPublic: "Öffentlich",
    chartPrivate: "Privat",
    chartVerified: "Verifiziert",
    chartNotVerified: "Nicht verifiziert",
    chartRiskHigh: "Hoch (≥55)",
    chartRiskMid: "Erhöht (30–54)",
    chartRiskFlagged: "Markiert (25–29)",
    chartRiskClean: "Niedrig (<25)",
    botsHint:
      "<strong>Nur Heuristik</strong> — kein Beweis für Bots. Nur Score ≥ 25. Sortiert nach Risiko unter deinen Followern.",
    needAnalysisFirst: "Zuerst eine volle Analyse starten, um Charts und Bot-Scores freizuschalten.",
    metricMutualRate: "Gegenseitig-Rate",
    metricNotBackRate: "Nicht-zurück-Rate",
    metricOneWayFollowers: "Einseitige Follower",
    metricBotFlagged: "Bot-markiert",
